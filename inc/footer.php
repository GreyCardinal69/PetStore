<div class="container-fluid"> 
  <div class="row">
    <nav aria-label="..." class="ml-auto mr-auto mt-3 mb-2">
      <ul class="pagination">
        ...
        <li class="page-item">
          <a class="page-link" href="product.php">Next</a>
        </li>
      </ul>
    </nav>
  </div>
...
<div class="container-fluid">
  <div class="row bg-dark text-light ">
    <div class="col-12 text-center pt-3">
      <a href="#"> <img  class=" mr-2 ml-2 float-left pt-2" src="https://image.flaticon.com/icons/svg/323/323477.svg" loading="lazy" width="30" height="30"></a>
      <a href="#"><img  class=" mr-2 ml-2 float-left pt-2" src="https://image.flaticon.com/icons/svg/216/216578.svg" loading="lazy" width="30" height="30"></a>
      <a href="#"><img  class=" mr-2 ml-2 float-left pt-2" src="https://image.flaticon.com/icons/svg/323/323437.svg"  loading="lazy" width="30" height="30"></a>
      <a href="#"><img class=" mr-2 ml-2 float-left pt-2" src="https://image.flaticon.com/icons/svg/216/216576.svg" loading="lazy" width="30" height="30"></a>
      <p class="text-center pt-2 pb-2 text-light float-right">&copy; Mikayel Kananov</p>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header text-dark">
        <h5 class="modal-title" class="text-dark">Login</h5>
      ...
      <div class="modal-body">
        <form>
          ...
          <div class="form-group form-check">
            ...
            <label class="form-check-label" for="exampleCheck1" class="text-dark">Remember Credentials</label>
          </div>
          <button type="submit" class="btn btn-primary" class="text-dark">Login</button>
        </form>
      </div>
    </div>
  </div>
...
<div class="modal" tabindex="-1" role="dialog" id="Register">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header text-dark">
        <h5 class="modal-title" class="text-dark">Register</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
        ...
        <form class="needs-validation" novalidate>
          <div class="form-row">
            <div class="col-md-6 mb-3">
              <label for="validationTooltip01" class="text-dark">First name</label>
              <input type="text" class="form-control" id="validationTooltip01" value="Mikayel" required>
              <div class="valid-tooltip" class="text-dark">
                Looks good!
              </div>
            </div>
            <div class="col-md-6 mb-3">
              <label for="validationTooltip02" class="text-dark">Last name</label>
              <input type="text" class="form-control" id="validationTooltip02" value="Kananov" required>
              <div class="valid-tooltip" class="text-dark">
                Looks good!
              </div>
            </div>
          ...
          <div class="form-row">
            <div class="col-md-6 mb-3">
              <label for="validationTooltip03" class="text-dark">City</label>
              <input type="text" class="form-control" id="validationTooltip03" required>
              <div class="invalid-tooltip" class="text-dark">
                Please provide a valid city.
              </div>
            </div>
            <div class="col-md-3 mb-3">
              <label for="validationTooltip04" class="text-dark">Gender</label>
            ...
            <div class="col-md-3 mb-3">
              <label for="validationTooltip05" class="text-dark">Phone Number</label>
          ...
          <button class="btn btn-primary" type="submit" class="text-dark">Submit form</button>
        </form>
      </div>
    </div>
  </div>
